...
try {
  ...
  // Only native HTTP MCP carries the invocation-bound read capability. Every
  // shell, including nested/native-wrapped commands, must stay in Seatbelt.
  childEnv.CAT_CAFE_GITHUB_READ_ONLY = 'true';
